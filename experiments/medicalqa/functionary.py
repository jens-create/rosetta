...
def generate_schema_from_functions(functions: List[Function], namespace="functions") -> str:
    ...
    schema = "// Supported function definitions that must be used.\n"
    ...
    for function in functions:
        ...
        if function_name == "QuestionAnswer":
            schema += """// Answer the multiple choice question with the given options. One of the given options is the correct answer to the question.
